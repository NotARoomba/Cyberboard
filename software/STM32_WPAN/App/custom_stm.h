...
typedef enum
{
  /* SENSOR_SERVICE */
  CUSTOM_STM_IMU_DATA,
  CUSTOM_STM_BARO_DATA,
} Custom_STM_Char_Opcode_t;

typedef enum
{
  /* IMU_DATA */
  CUSTOM_STM_IMU_DATA_READ_EVT,
  CUSTOM_STM_IMU_DATA_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_IMU_DATA_NOTIFY_DISABLED_EVT,
  /* BARO_DATA */
  CUSTOM_STM_BARO_DATA_READ_EVT,
  CUSTOM_STM_BARO_DATA_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_BARO_DATA_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeImu_Data;
extern uint16_t SizeBaro_Data;
